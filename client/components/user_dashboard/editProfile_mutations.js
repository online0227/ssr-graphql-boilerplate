...
import "./editProfile_mutations.css"
...
class EditProfileMutations extends React.Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Mutation mutation={SET_PROFILE_IMAGE} variables={{ email: this.props.session.getCurrentUser.email, profileImage: newFile }} refetchQueries={() => [
                  ...
                  <div className="grid">
                    ...
                    <div className="column column_6_12 image">
                      {!this.props.session.getCurrentUser.profileImage &&
                        <img src={"/public/img/assets/texture.jpg"} />
                      }
                      {this.props.session.getCurrentUser.profileImage &&
                        <img src={`/public/user-profile/${this.props.session.getCurrentUser.profileImage}`} />
                      }
                    </div>
        ...
        <Mutation
          ...
          variables={{ email: this.props.session.getCurrentUser.email, bio }} refetchQueries={() => [
            ...
            return (
              ...
              <form className="form" onSubmit={event => this.handleSaveBio(event, editProfile)}>
                ...
                <div className="form_wrap editBioForm">
                  ...
                  <div
                    style={{ errorLabel: this.state.error != '' }}
                  >
                    {this.state.error}
                  </div>
